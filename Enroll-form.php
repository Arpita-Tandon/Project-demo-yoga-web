<div class="formbold-main-wrapper bg-main" >
  <div class="formbold-form-wrapper">
    <form action="https://formbold.com/s/FORM_ID" method="POST">
      <div class="formbold-form-title">
        <h2 class="">Register now for join our yoga studio</h2>
        <p>
           Register yourself in our yoga studio here you learn hatha yoga and more courses are provide.
        </p>
      </div>
